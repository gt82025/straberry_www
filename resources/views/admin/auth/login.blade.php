...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" role="form" method="POST" action="{{ url('/AdaLogin') }}">
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> 2016 &copy; Majors Design - Ada CMS. alpha.221b. </div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
